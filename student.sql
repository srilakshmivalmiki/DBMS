...
(3, 'Lahari', 20, 'Physics', '1st', '345-678-9012', 'lahari@email.com'),
(4, 'Amrutha', 20, 'Chemistry', '4th', '456-789-0123', 'amrutha@email.com'),
(5, 'srilakshmi', 20, 'History', '2nd', '567-890-1234', 'srilakshmi@email.com'),
(6, 'Venkata Kavitha', 20, 'English', '3rd', '678-901-2345', 'kavitha@email.com'),
(7, 'Malini', 21, 'Biology', '1st', '789-012-3456', 'malini@email.com'),
(8, 'misba', 20, 'Economics', '4th', '890-123-4567', 'misba@email.com'),
(9, 'Rehana', 19, 'Sociology', '2nd', '901-234-5678', 'rehana@email.com'),
(10, 'Samreen', 20, 'Political Science', '3rd', '012-345-6789', 'samreen@email.com');
